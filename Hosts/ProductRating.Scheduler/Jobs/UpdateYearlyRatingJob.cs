...
{
    public class UpdateYearlyRatingJob : IJob
    {
        private readonly IUpdateRatingService _updateRatingService;

        public UpdateYearlyRatingJob(IUpdateRatingService updateRatingService)
        {
        ...
        {
            var result = await _updateRatingService.UpdateRatingAsync(UpdateRatingType.YearlyRating);
